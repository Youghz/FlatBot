...
echo ""
echo "3. RUN:"
echo "   uv run python main.py              # Run once"
echo "   uv run python main.py --schedule   # Run every hour"
echo ""
echo "4. CRON (optional - run every hour automatically):"
echo "   crontab -e"
echo "   Add: 0 * * * * cd $PROJECT_DIR && uv run python main.py >> flat-research.log 2>&1"
